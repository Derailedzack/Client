...
public abstract class GuiContainer extends GuiScreen
{
    ...
    protected void mouseClicked(int i, int j, int k)
    {
        ...
        if(k == 0 || k == 1)
        {
            ...
            if(j1 != -1)
            {
                ...
                mc.playerController.handleMouseClick(inventorySlots.windowId, j1, k, flag1, mc.thePlayer);
            }
        }
    }
    ...
    public void onGuiClosed()
    {
        ...
        {
            mc.playerController.onCraftGuiClosed(inventorySlots.windowId, mc.thePlayer);
            return;
        }
    }
