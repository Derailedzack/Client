...
public class Item
{
    ...
    public static Item ingotHardenedIron = (new Item(2002)).setIconCoord(6, 6).setItemName("hardenedIron");
    public static Item weavedIron = (new Item(2003)).setIconCoord(6, 7).setItemName("weavedIron");
