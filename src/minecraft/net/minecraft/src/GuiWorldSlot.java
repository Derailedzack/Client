...
class GuiWorldSlot extends GuiSlot
{
    ...
    protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator)
    {
        ...
        {
            s = (new StringBuilder()).append(GuiSelectWorld.getlocalizedWorldText(parentWorldGui)).append(" ").append(i + 1).toString();
        }
        ...
        {
            s2 = (new StringBuilder()).append(GuiSelectWorld.getLocalizedMustConvertText(parentWorldGui)).append(" ").append(s2).toString();
        }
