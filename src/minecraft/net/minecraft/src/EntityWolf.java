...
public class EntityWolf extends EntityAnimal
{
    ...
    public void onUpdate()
    {
        ...
        {
            headRotationCourse = headRotationCourse + (1.0F - headRotationCourse) * 0.4F;
        } else
        {
            headRotationCourse = headRotationCourse + (0.0F - headRotationCourse) * 0.4F;
        }
        if(looksWithInterest)
        {
    ...
    {
        return (headRotationCourseOld + (headRotationCourse - headRotationCourseOld) * f) * 0.15F * 3.141593F;
    }
