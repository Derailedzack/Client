...
import me.moderator_man.osm.PlayerCapabilities;
...
public abstract class EntityPlayer extends EntityLiving
{
    ...
    {
        playerCloakUrl = (new StringBuilder()).append(cloakUrl).toString();
    ...
    {
    	/*if (playerCapabilities.getFlag("nofall") && !playerCapabilities.getFlag("flight"))
