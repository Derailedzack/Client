...
public class Block
{
    ...
    {
        setNeighborNotifyOnMetadataChange[blockID] = true;
        return this;
    }
    ...
    public boolean isVecInsideYZBounds(Vec3D vec3d)
    {
        if(vec3d == null)
        {
            return false;
    ...
    public boolean isVecInsideXZBounds(Vec3D vec3d)
    {
        if(vec3d == null)
        {
            return false;
    ...
    public boolean isVecInsideXYBounds(Vec3D vec3d)
    {
        if(vec3d == null)
        {
            return false;
    ...
    public static final int blockIDMax = 1000;
    ...
    //TODO: OSM
    public Block setEnableStats(boolean flag)
    {
    	enableStats = flag;
    	return this;
    }
    
    public Block setMinBounds(double x, double y, double z)
    {
    	minX = x;
    	minY = y;
    	minZ = z;
    ...
    public Block setMaxBounds(double x, double y, double z)
    {
    	maxX = x;
    	maxY = y;
    	maxZ = z;
    ...
    public Block setParticleGravity(float val)
    {
    	blockParticleGravity = val;
    	return this;
    }
    
    public Block setSlipperiness(float val)
    {
    	slipperiness = val;
    	return this;
    }
    ...
    static 
    {
        ...
        blocksList = new Block[blockIDMax]; // increase block id limit to 1000
