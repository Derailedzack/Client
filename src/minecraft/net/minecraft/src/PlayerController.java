...
public class PlayerController
{
    ...
    {
    	EntityPlayerSP player = new EntityPlayerSP(mc, world, mc.session, world.worldProvider.worldType);
        return player;
    }
    ...
    public ItemStack handleMouseClick(int i, int j, int k, boolean flag, EntityPlayer entityplayer)
    {
