...
public class GuiAchievements extends GuiScreen
{
    ...
    public GuiAchievements(StatFileWriter statfilewriter)
    {
        ...
        char c = '\215';
        char c1 = '\215';
        xScrollO = xScrollP = xScrollTarget = AchievementList.openInventory.displayColumn * 24 - c / 2 - 12;
        yScrollO = yScrollP = yScrollTarget = AchievementList.openInventory.displayRow * 24 - c1 / 2;
    }
    ...
    public void updateScreen()
    {
        xScrollO = xScrollP;
        yScrollO = yScrollP;
        double d = xScrollTarget - xScrollP;
        ...
        {
            xScrollP += d * 0.84999999999999998D;
    ...
    protected void drawAchievementScreen(int i, int j, float f)
    {
        int k = MathHelper.floor_double(xScrollO + (xScrollP - xScrollO) * (double)f);
        int l = MathHelper.floor_double(yScrollO + (yScrollP - yScrollO) * (double)f);
        if(k < X_MIN)
        {
            k = X_MIN;
        }
