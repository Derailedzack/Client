...
public class TileEntityRendererPiston extends TileEntitySpecialRenderer
{
            ...
            float f)
    {
        ...
        if(block != null && tileentitypiston.getProgress(f) < 1.0F)
        {
            ...
            if(tileentitypiston.func_31012_k() && !tileentitypiston.isExtending())
            {
                Block.pistonExtension.setHeadTexture(((BlockPistonBase)block).getPistonExtensionTexture());
                field_31071_b.func_31079_a(Block.pistonExtension, tileentitypiston.xCoord, tileentitypiston.yCoord, tileentitypiston.zCoord, tileentitypiston.getProgress(f) < 0.5F);
