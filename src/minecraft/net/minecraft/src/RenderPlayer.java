...
public class RenderPlayer extends RenderLiving
{
            ...
            float f, float f1)
    {
        ...
        modelArmorChestplate.heldItemRight = modelArmor.heldItemRight = modelBipedMain.heldItemRight = false;
    }
    ...
    protected void func_22016_b(EntityPlayer entityplayer, double d, double d1, double d2)
    {
        ...
        {
            super.func_22012_b(entityplayer, d + (double)entityplayer.renderOffsetX, d1 + (double)entityplayer.renderOffsetY, d2 + (double)entityplayer.renderOffsetZ);
        } else
        {
