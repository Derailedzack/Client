...
class GuiSlotStatsBlock extends GuiSlotStats
{
    ...
    protected void func_27260_a(int i, int j, Tessellator tessellator)
    {
        ...
        if(field_27268_b == 0)
        {
            GuiStats.drawSprite(theStats, ((i + 115) - 18) + 1, j + 1 + 1, 18, 18);
        } else
        {
            GuiStats.drawSprite(theStats, (i + 115) - 18, j + 1, 18, 18);
        }
        if(field_27268_b == 1)
        {
            GuiStats.drawSprite(theStats, ((i + 165) - 18) + 1, j + 1 + 1, 36, 18);
        } else
        {
            GuiStats.drawSprite(theStats, (i + 165) - 18, j + 1, 36, 18);
        }
        if(field_27268_b == 2)
        {
            GuiStats.drawSprite(theStats, ((i + 215) - 18) + 1, j + 1 + 1, 54, 18);
        } else
        {
            GuiStats.drawSprite(theStats, (i + 215) - 18, j + 1, 54, 18);
        }
    }
    ...
    protected void drawSlot(int i, int j, int k, int l, Tessellator tessellator)
    {
        ...
        GuiStats.drawItemSprite(theStats, j + 40, k, i1);
    ...
    final GuiStats theStats; /* synthetic field */
}
