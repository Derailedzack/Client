...
{
	//TODO: moderator_man
	private static Minecraft osMC1337;
        ...
        if(world != null)
        {
            ...
            if(thePlayer == null)
            {
                try
                {
                    ...
                    //TODO: OSM
                    OSM.INSTANCE.EVENT_MANAGER.register(thePlayer);
                } catch (Exception ex) {
                	System.out.println("EventManager#register(thePlayer)");
                	ex.printStackTrace();
                }
            }
            try
            {
            	...
            	System.out.println("thePlayer#movementInput");
            	ex.printStackTrace();
            }
